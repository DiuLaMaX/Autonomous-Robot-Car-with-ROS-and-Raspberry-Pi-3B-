...
set(MSG_I_FLAGS "-Imotor:/home/pi/car/src/motor/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/car/src/motor/msg/moveMotorCommand.msg" NAME_WE)
add_custom_target(_motor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motor" "/home/pi/car/src/motor/msg/moveMotorCommand.msg" ""
)

get_filename_component(_filename "/home/pi/car/src/motor/srv/moveMotor.srv" NAME_WE)
add_custom_target(_motor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "motor" "/home/pi/car/src/motor/srv/moveMotor.srv" ""
)
...
_generate_msg_cpp(motor
  "/home/pi/car/src/motor/msg/moveMotorCommand.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(motor
  "/home/pi/car/src/motor/srv/moveMotor.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/motor
)
