...
message(STATUS "camera: 1 messages, 0 services")

set(MSG_I_FLAGS "-Icamera:/home/pi/car/src/camera/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/pi/car/src/camera/msg/position.msg" NAME_WE)
add_custom_target(_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "camera" "/home/pi/car/src/camera/msg/position.msg" ""
)
...
_generate_msg_cpp(camera
  "/home/pi/car/src/camera/msg/position.msg"
  "${MSG_I_FLAGS}"
  ""
